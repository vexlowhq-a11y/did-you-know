(function () {
  ...
  /* Los links de artículos en data/articulos.js están guardados "desde la raíz"
     ...
     ruta incluye toda la carpeta de tu computadora (C:/Users/.../didyouknow/...)
  ...
  var RAIL_CATEGORIES = ['ai', 'tecnology', 'science-space', 'gaming', 'entertainment', 'sports', 'world'];
  ...
  if (articleShare) {
    ...
    var shareTitle = document.title.replace(/ — Did You Know?$/, '');
