...
SITE_URL = "https://didyouknow.com"
IMAGE_EXT = {".png", ".jpg", ".jpeg", ".jfif", ".gif", ".webp", ".avif", ".svg"}

# Las categorías son editables desde el panel (data/categories.json), no
# están hardcodeadas — se cargan acá y se derivan las mismas tres
# estructuras (CATEGORY_SLUGS/CATEGORY_LABELS/DESCRIPTIONS) que usa el
# resto de este archivo, para no tener que tocar nada más abajo.
...
for _c in _categories_data:
    _entry = {"slug": _c["slug"], "icon": _c.get("icon", "📰")}
    if _c.get("hasNote"):
...
UI_STRINGS = {
    ...
    "all_coverage_of": "All Did You Know? coverage of {topic}.",
    ...
    "byline": "Did You Know? Staff", "share": "Share",
...
# ============================================================================
# STATIC_PAGES — páginas sueltas de una sola pantalla (About Did You Know?, Legal,
# etc.), viven en la raíz del sitio, igual que index.html.
# ============================================================================
STATIC_PAGES = [
    {"slug": "about-didyouknow", "label": "About Did You Know?"},
...
STATIC_PAGE_DESCRIPTIONS = {
    "about-didyouknow": "Who we are and what Did You Know? is.",
    "editorial-policy": "How we choose, write, and correct what we publish.",
    "contact": "How to get in touch with Did You Know?.",
    "advertise": "Ad placements and contact info for advertisers.",
    "privacy": "What information we collect and how we use it.",
    "terms": "Terms and conditions for using Did You Know?.",
    "cookies": "What cookies we use and how to manage them.",
}

STATIC_PAGE_BODIES = {
    "about-didyouknow": [
        ("p", "Did You Know? started with a simple idea: bring the most interesting things happening in the world into one place, whether that's artificial intelligence, a big game launch, a scientific discovery, or the story everyone's talking about on social media."),
        ("h2", "What we cover"),
    ...
    "editorial-policy": [
        ...
        ("p", "Did You Know? is supported by advertising (including Google AdSense). Ads are always clearly labeled and kept separate from editorial content. If we ever publish sponsored content, it will be clearly marked as such."),
    ],
    "contact": [
        ("p", "Have a correction, a suggestion, or just want to reach out? This is the place."),
        ("h2", "General inquiries"),
        ("p", "Email us at <a href=\"mailto:contact@didyouknow.com\">contact@didyouknow.com</a> and we'll get back to you as soon as we can."),
        ("h2", "Advertising inquiries"),
        ("p", "Looking to advertise on Did You Know?? Visit <a href=\"advertise.html\">Advertise With Us</a> or email us directly at <a href=\"mailto:ads@didyouknow.com\">ads@didyouknow.com</a>."),
    ],
    "advertise": [
        ("h2", "Why advertise on Did You Know?"),
        ("p", "Did You Know? is a content discovery site covering artificial intelligence, technology, science, gaming, entertainment, sports, world news, curiosities, guides, social media, and business — built for a general audience that wants to stay current."),
        ...
        ("p", "Email <a href=\"mailto:ads@didyouknow.com\">ads@didyouknow.com</a> and tell us what you're looking for — we'll follow up with options and availability."),
    ],
    "privacy": [
        ("h2", "Information we collect"),
        ("p", "Did You Know? doesn't require you to register or create an account to read our content. We don't collect personal data directly, beyond the standard technical information any website receives from a visit (like browser type or the page you came from)."),
        ...
        ("h2", "Contact"),
        ("p", "If you have questions about this policy, email us at <a href=\"mailto:contact@didyouknow.com\">contact@didyouknow.com</a>."),
    ],
    "terms": [
        ("h2", "Acceptance of terms"),
        ("p", "By using Did You Know?, you agree to these terms of use. If you don't agree, please don't use the site."),
        ("h2", "Use of content"),
        ("p", "Content published on Did You Know? is for informational and entertainment purposes only. It should not be treated as professional, financial, medical, or legal advice."),
        ("h2", "Intellectual property"),
        ("p", "Text, graphics, and the design of Did You Know? are the property of Did You Know? unless otherwise noted. Reproducing content without permission isn't allowed, beyond brief quotes with proper attribution and a link back to the original story."),
        ("h2", "Links to other sites"),
        ("p", "Did You Know? may include links to third-party sites. We're not responsible for the content or privacy practices of those sites."),
        ("h2", "Limitation of liability"),
        ("p", "We do our best to keep published information accurate, but we don't guarantee it's always error-free. Did You Know? isn't liable for decisions made based on the site's content."),
        ...
        ("h2", "Contact"),
        ("p", "Questions about these terms? Email us at <a href=\"mailto:contact@didyouknow.com\">contact@didyouknow.com</a>."),
    ],
    "cookies": [
        ("h2", "What cookies are"),
...
<title>{label} — Did You Know?</title>
<meta name="description" content="{desc}">
<link rel="stylesheet" href="{asset_prefix}css/style.css">
<link rel="icon" type="image/svg+xml" href="{asset_prefix}img/favicon.svg">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>{topic_label} — {cat_label} — Did You Know?</title>
